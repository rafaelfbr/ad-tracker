    ...
    <div className="min-h-screen bg-subtle">
      ...
      <div className="px-6 lg:px-8 pt-6 pb-2">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-foreground tracking-tight">Ofertas Marcadas</h1>
            <p className="text-sm text-muted-foreground mt-0.5">Visão geral das ofertas monitoradas</p>
          </div>
          <Link href="/new">
